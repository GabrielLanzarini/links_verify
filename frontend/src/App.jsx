...
export default function App() {
    ...
    return (
        <div className="w-screen h-screen p-4 bg-white">
            ...
            <div ref={screen} className={`sm:hidden w-full h-full bg-[#f9f5ff] flex gap-5 flex-col justify-center items-center`}>
                <Modal refreshLinks={handleLinks} modal={modal} handleCloseModal={handleCloseModal} />

                <div className="flex flex-col items-center justify-center gap-4">
                    <h1 className={`test font-bold  sm:text-3xl text-5xl text-[#28262C] `}>
                        (Link_<span className="text-[#998FC7]">Verify)</span>
                    </h1>
                    <h2 className="text-2xl">Your folder links:</h2>

                    <div className="md:w-[500px]  w-[600px] min-h-[50px] flex gap-5 flex-wrap justify-center items-center">
                        {loading ? (
